...
export const tokens = {
  ...
  components: {
    ...
    btnPrimary: 'bg-teal hover:bg-teal-light text-white font-display font-semibold px-6 py-2.5 rounded-button transition-all duration-300 shadow-teal-glow hover:scale-[1.02]',
    btnOutline: 'border border-border-strong text-teal hover:bg-teal hover:text-white font-display font-semibold px-6 py-2.5 rounded-button transition-all duration-300',
